...
class Harvester:
    ...
    def __init__(
        ...
        """
        self.ogm_path = ogm_path or os.path.join("tmp", "opengeometadata")
...
def main():
    ...
    parser.add_argument(
        "--ogm-path",
        default=os.path.join("tmp", "opengeometadata"),
    ...
    harvester = Harvester(ogm_path=args.ogm_path, schema_version=args.schema_version)
