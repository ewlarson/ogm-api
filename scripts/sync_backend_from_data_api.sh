...
GEOBTAA_API_REMOTE_NAME=$REMOTE_NAME
GEOBTAA_API_REMOTE_URL=$REMOTE_URL
GEOBTAA_API_BRANCH=$UPSTREAM_BRANCH
GEOBTAA_API_BACKEND_PREFIX=$BACKEND_PREFIX
GEOBTAA_API_BACKEND_SPLIT_BRANCH=$SPLIT_BRANCH

# Updated after an applied import.
GEOBTAA_API_LAST_IMPORT_COMMIT=$UPSTREAM_COMMIT
GEOBTAA_API_LAST_BACKEND_SPLIT_COMMIT=$SPLIT_COMMIT
GEOBTAA_API_LAST_IMPORT_AT=$imported_at
EOF
