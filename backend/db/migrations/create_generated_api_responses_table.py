...
from db.models import generated_api_response_tags, generated_api_responses, metadata  # noqa: E402

logging.basicConfig(level=logging.INFO)
logger = logging.getLogger(__name__)


def create_generated_api_responses_table() -> None:
    ...
    logger.info("Ensuring generated_api_responses tables via metadata.create_all()...")
    _ = (generated_api_responses, generated_api_response_tags)
    ...
    logger.info("generated_api_responses tables ready")
